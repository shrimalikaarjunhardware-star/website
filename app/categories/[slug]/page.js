          ...
          <div className="product-grid large pro-grid">
            {allItems.length === 0 ? (
              <div className="empty-state collection-empty-state">
                <strong>No products currently available in this collection.</strong>
                <p>There are no products currently available that fall in this category. Have fun browsing our other product collections.</p>
                <Link href="/categories" className="btn btn-black">BROWSE OTHER COLLECTIONS</Link>
              </div>
            ) : items.length ? (
